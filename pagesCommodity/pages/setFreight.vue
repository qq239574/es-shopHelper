<template>
    <div class='setfreight page'>
        <radioBlock :items='list' :defaultIndex='defaultIndex' :hideRightArrow='true' valueStyle='color:#fb6638; margin-left: 0;' fontStyle='font-size: 28upx;' @clickItem='change'></radioBlock>
