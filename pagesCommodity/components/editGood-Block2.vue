...
<template>
    <view class="provide-block">
        <form @submit="formSubmit" class="grace-form">
            ...
            <inputItem label='售卖价格' type='digit' :other='info.price' :value='info.price.value' @input="inputCell"></inputItem>
            ...
            <inputItem label='商品库存' type='number' :other='info.stockNum' :value='info.stockNum.value' @input="inputCell" v-else></inputItem>
