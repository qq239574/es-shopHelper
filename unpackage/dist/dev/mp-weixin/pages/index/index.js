...

{
  ...
  methods: {
    ...
    toNotice: function toNotice(val) {
      this.Cacher.setData('home', _objectSpread({ from: 'home' }, val)); //页面传参
      uni.navigateTo({
