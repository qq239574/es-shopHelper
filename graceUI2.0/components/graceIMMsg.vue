...
.grace-im-msg .face{width:40px; height:40px; border-radius:40px; overflow:hidden; flex-shrink:0;}
.grace-im-msg .face image{width:100%; border-radius:3px;}
.grace-im-name{line-height:24rpx; height:24rpx; font-size:24rpx; padding-bottom:16rpx; text-indent:5px; color:#00B26A;  padding-left:8px;}
.grace-im-name text:last-child{color:#666; font-size:20rpx; margin-left:10px;}
.grace-im-msg .content{width:auto; padding:6px 12px; margin:8px 15px; max-width:500rpx; background:#FFF; line-height:1.6; border-radius:3px; position:relative; word-break:break-all; display:inline-block;}
