...
.grace-date-time .timer picker{width:100%; height:80upx; line-height:80upx !important; text-align:center;}
.grace-date-time .timer-spliter{width:30px; flex-shrink:0; text-align:center; line-height:80upx !important; font-size:20px;}
